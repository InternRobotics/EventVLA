...
class ModelClient:
    ...
    def __init__(
        ...
        if not self.uses_keyframe_image_inputs:
            raise ValueError("EventVLA eval only supports pure_image_keyframe_memory raw image memory.")
        self.supports_runtime_memory_commits = True
