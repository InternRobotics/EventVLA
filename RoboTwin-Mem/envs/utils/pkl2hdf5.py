...
def pkl_files_to_hdf5_and_video(pkl_files, hdf5_path, video_path):
    ...
    temp_dir = tempfile.mkdtemp(prefix="robotwin_mem_hdf5_")
    temp_hdf5_path = os.path.join(temp_dir, os.path.basename(hdf5_path) or "episode.hdf5")
    try:
        ...
        if os.path.exists(hdf5_path):
            os.remove(hdf5_path)
        shutil.copyfile(temp_hdf5_path, hdf5_path)
    finally:
