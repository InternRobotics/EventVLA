...
- [GO-1 Fine-tuning and Evaluation](#go-1-fine-tuning-and-evaluation)
  ...
  - [Environment Setup](#environment-setup)
    - [1. Install RoboTwin-Mem](#1-install-robotwin-mem)
    - [2. Install GO-1](#2-install-go-1)
  - [Data Generation](#data-generation)
  - [Data Processing](#data-processing)
    - [1. Convert RoboTwin-Mem Data to HDF5](#1-convert-robotwin-mem-data-to-hdf5)
    - [2. Convert HDF5 to LeRobot Dataset](#2-convert-hdf5-to-lerobot-dataset)
  - [Model Fine-tuning](#model-fine-tuning)
  - [Evaluation](#evaluation)
    - [Start GO-1 Server](#start-go-1-server)
    - [Start RoboTwin-Mem Client](#start-robotwin-mem-client)
  - [Evaluation Results](#evaluation-results)

## Environment Setup

### 1. Install RoboTwin-Mem

Create the conda environment and install the dependencies for RoboTwin-Mem according to the [RoboTwin docs](https://robotwin-platform.github.io/doc/usage/robotwin-install.html).
...
Follow the [RoboTwin docs](https://robotwin-platform.github.io/doc/usage/collect-data.html) to generate raw data in RoboTwin-Mem format.
...
### 1. Convert RoboTwin-Mem Data to HDF5

```bash
# Activate the RoboTwin-Mem environment
conda activate RoboTwin-Mem

bash robotwin2hdf5.sh <task_name> <task_config> <expert_data_num>

# Example:
bash robotwin2hdf5.sh pick_the_unhidden_block demo_clean 50
```
...
# Example:
bash hdf52lerobot.sh processed_data/pick_the_unhidden_block-demo_clean-50/ pick_the_unhidden_block_repo
```
...
# Example:
bash eval.sh pick_the_unhidden_block demo_clean go1_demo 0 0
```

**Arguments:**
- `task_name` - Name of the task (*e.g.*, `pick_the_unhidden_block`)
